...
- il comando (_richiesta_ o _risposta_)
- la versione (_RIPv1_ è classfull, _RIPv2_ usa le netmask)
- una lista di subnet descritte da indirizzi IP e subnet mask (solo se _RIPv2_)

I pacchetti di _richiesta_ chiedono ai vicini i rispettivi [[distance vector]].
I pacchetti di _risposta_ trasferiscono i [[distance vector]] richiesti.

> [!warning] Evitare i sincronismi
> La temporizzazione prevede l’aggiunta di _jitter_ ai 30 secondi per evitare sincronismi globali e l’invalidazione di un prefisso se non aggiornato per un certo intervallo (ad esempio 180 secondi).
