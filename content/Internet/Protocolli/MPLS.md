...
> - **TTL**: i router LSR non vedono l’IP TTL mentre il pacchetto è incapsulato, quindi: - MPLS usa il proprio TTL nell’etichetta - il PE copia il TTL IP nel TTL MPLS all’ingresso - i P decrementano il TTL nell'etichetta - quando si rimuovono le label, i valori vengono propagati fino a ripristinare il TTL IP.
