...
> [!tip]
> Ogni host è _direttamente connesso_ a un router quindi il problema dell'instradamento si riduce all'instradamento del pacchetto dal router sorgente al router destinatario.
...
- negli algoritmi di _routing isolato_ ogni IS prende le decisioni usando solo le loro informazioni locali. Gli algoritmi [[Hot Potato]] e [[Backward Learning]] sono di questo tipo.
- negli algoritmi di _routing distribuito_ gli IS si comunicano tra loro informazioni sulla rete. Gli algoritmi [[Distance Vector]] e [[Link State Packet]] sono algoritmi di questo tipo.
