...
Nel Backward Learning, quando un _intermediate system_ riceve un pacchetto proveniente da, ad esempio, una certa sorgente A su una linea L3, memorizza nella propria tabella che per raggiungere A si usa la linea L3. In questo modo l'IS costruisce dinamicamente le proprie tabelle di instradamento basandosi sul traffico che attraversa la rete, senza scambi espliciti di informazioni di routing con gli altri nodi.
​
