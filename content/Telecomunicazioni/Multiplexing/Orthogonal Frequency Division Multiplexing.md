...
L'_Orthogonal Frequency Division Multiplexing_ (**OFDM**) ha rivoluzionato il panorama delle telecomunicazioni (è la base di 4G, 5G, Wi-Fi moderno e ADSL) per rimediare all'inefficienza dello spettro del vecchio [[Frequency Division Multiplexing|FDM]].
...
La _modulazione_ è digitale ([[Phase Shift Keying|PSK]] o [[Quadrature Amplitude Modulation|QAM]]) ed è usata per mappare i simboli alle $N$ sottoportanti.

La complessità temporale dell'_IFFT_ è $O(N\log N)$.
