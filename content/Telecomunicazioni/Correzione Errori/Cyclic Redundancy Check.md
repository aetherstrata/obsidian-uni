...
tags:
  ...
  - errori
---
Il *Cyclic Redundancy Check* (**CRC**) è il metodo più diffuso ed efficiente al mondo per verificare l'integrità dei dati digitali. Viene impiegato in molti campi: dalle reti Ethernet e Wi-Fi (pacchetti TCP/IP), ai sistemi di archiviazione come hard disk e memorie flash, fino ai file compressi (.zip).
...
$$
Per implementare questo algoritmo in hardware, si prendono 24 celle di memoria *flip-flop* per fare lo *shift register*.
