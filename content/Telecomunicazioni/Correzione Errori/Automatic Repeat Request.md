...
tags:
  ...
  - digitale
---
L'**ARQ** è un meccanismo di correzione degli errori *reattivo*: accetta la possibilità che un pacchetto arrivi errato e, anziché cercare di correggerlo, si concentra sulla probabilità di scoperta dell'errore e, in caso di errori, richiede al mittente una nuova trasmissione.
## Funzionamento
...
Se il trasmettitore non riceve né ACK né NACK entro un tempo massimo prefissato (*timeout*), assume che il pacchetto (o il riscontro) sia andato perso e **ritrasmette in automatico** i dati salvati nel buffer.
...
2) **Latenza variabile:** Questo è il difetto più grande dell'ARQ. Aspettare un ACK e ritrasmettere pacchetti richiede molto tempo. Questo genera un ritardo imprevedibile (*jitter*) nella comunicazione.
