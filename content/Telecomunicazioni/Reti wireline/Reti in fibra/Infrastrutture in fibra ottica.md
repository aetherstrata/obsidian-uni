...
- **Cablaggio ad alta densità**: connettori MPO/MTP con 12, 24 o 72 fibre, organizzati in *Zone Distribution Area* (**ZDA**)
...
### Reti di Accesso PON
Le reti **PON** (*Passive Optical Network*) portano la fibra fino all'utente finale (FTTH) o all'armadio di quartiere (FTTC). Il termine "passivo" indica che tra la centrale (OLT) e l'utente (ONU/ONT) non ci sono elementi attivi alimentati: il segnale viene splittato tramite **splitter ottici passivi**. Gli standard evolutivi sono:
